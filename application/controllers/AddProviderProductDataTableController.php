...
/**
 * Controlador de tabla de relacion de productos con proveedores
 * @author maque
 *
 */
class AddProviderProductDataTableController extends DataTableController {
	...
	public function search($page, array $parameters, $isRecordCount = false){
		...
		$pu = new \Controllers\ProductUserController();
